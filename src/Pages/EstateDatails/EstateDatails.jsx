...
const EstateDatails = () => {
    ...
    const estateDetail = estateDetails.find(aEstateDetail => aEstateDetail.id === idInt)
    const { estate_title, image, segment_name, description, location, price, area, facilities, status } = estateDetail
    return (
        <div>
            <Helmet>
                <title>RealBizz | Estate Details</title>
            </Helmet>
            <NavBar></NavBar>
            <div   className="p-6 border rounded-md shadow-lg card bg-base-100 dark:bg-gray-50 dark:text-gray-900">
                <div className='relative'>
                    <img src={image} alt="" className="object-cover dark:opacity-90 object-center w-full rounded-md  dark:bg-gray-500" />
