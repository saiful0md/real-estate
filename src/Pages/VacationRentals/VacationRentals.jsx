...
const VacationRentals = ({estate}) => {
    const { id, estate_title, image, segment_name, description, location, price, area, facilities, status } = estate;
    useEffect(() => {
        AOS.init({ duration: 1200 });
    })
    return (
        <div  data-aos="fade-right" className="p-6 border justify-between shadow-lg card bg-base-100 dark:bg-gray-50 dark:text-gray-900">
